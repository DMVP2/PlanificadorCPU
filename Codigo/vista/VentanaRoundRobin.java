...
public class VentanaRoundRobin extends JFrame
{
		...
		public VentanaRoundRobin(Controlador controlador)
		{
			labCantidadProcesos = new JLabel();
			Font font = new Font("Courier", Font.BOLD, 14);
			labCantidadProcesos.setFont(font);
			
			labQuantum = new JLabel();
			labQuantum.setFont(font);
			...
			btnEjecutar = new JButton("Ejecutar - Round Robin");
			btnEjecutar.setActionCommand("Ejecutar - Round Robin");
			...
			layout.putConstraint(SpringLayout.WEST, labQuantum, 1330, SpringLayout.WEST, this);		
			layout.putConstraint(SpringLayout.EAST, labQuantum, 1500, SpringLayout.WEST, this);
			layout.putConstraint(SpringLayout.NORTH, labQuantum, 130, SpringLayout.NORTH, this);
			layout.putConstraint(SpringLayout.SOUTH, labQuantum, 170, SpringLayout.NORTH, this);
		...
		public void inicializarDatos()
		{
			...
			else
			{
				...
				quantum = (int) Math.floor(Math.random()*(7-1+1)+1);
				
				labQuantum.setText("Quantum: " + quantum);
		...
		public JLabel getLabQuantum() {
			return labQuantum;
		}

		public void setLabQuantum(JLabel labQuantum) {
			this.labQuantum = labQuantum;
		}
