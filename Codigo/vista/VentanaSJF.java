...
public class VentanaSJF extends JFrame
{
		...
		public VentanaSJF(Controlador controlador)
		{
			...
			btnEjecutar = new JButton("Ejecutar - SJF");
			btnEjecutar.setActionCommand("Ejecutar - SJF");
