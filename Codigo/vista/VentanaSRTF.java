...
public class VentanaSRTF extends JFrame
{
		...
		public VentanaSRTF(Controlador controlador)
		{
			...
			btnEjecutar = new JButton("Ejecutar - SRTF");
			btnEjecutar.setActionCommand("Ejecutar - SRTF");
		...
		public void inicializarDatos()
		{
			...
			else
			{
				...
				{
					llegada[i] = (int) Math.floor(Math.random()*(5-0+1)+0);
				}
		...
		public void insertarDatosIniciales()
		{
			...
			areaTabla.setText(areaTabla.getText() + "Procesos " + " Tiempo de ejecución " +  " Tiempo de llegada "); 
			
			for (int i = 0; i < cantidad; i++) 
			{
				areaTabla.setText(areaTabla.getText() + "\n" + " " + procesos[i] + "\t" + tiempos[i] + "\t\t " + llegada[i]);
			}
		}
